...
public class DangNhap_GUI extends JFrame implements ActionListener,ItemListener{
	...
	public DangNhap_GUI() {
		...
		JLabel lblCngTyXy = new JLabel("CÔNG TY XÂY DỰNG THĂNG LONG");
		...
		JLabel lblNewLabel_1 = new JLabel(" Đăng nhập quản lý");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == btnDangNhap) {
			QuanLy quanLy = dangNhap_Dao.getQuanLy(txtMaQuanLy.getText()); // lấy dl từ db
