...
public class TimNTFrm extends JFrame implements ActionListener, MouseListener{
	...
	private DSNT dao;
	private List<NhaTro> dsnt = null;
	String tenNT;
	JLabel lbTT;
	JComboBox cmbSelect;
	JButton btnTim, btnXoaDC;
	JTextField txtNhap;
	JPanel pn;
	//
	...
	String headers[] = {"Address", "Chủ Trọ", "Số Điện Thoại", "Số phòng trống"};
	JScrollPane scroll;
	public TimNTFrm() {
		...
		cmbSelect.addItem("Tên nhà trọ");
		cmbSelect.addItem("Chủ Trọ");
		cmbSelect.addItem("Số điện thoại");
		...
		btnXoaDC = new JButton("Xóa");
		pnSouth.add(btnXoaDC);
		ctn.add(pnSouth, BorderLayout.SOUTH);
		//
		...
		cmbSelect.addMouseListener(new MouseListener() {
