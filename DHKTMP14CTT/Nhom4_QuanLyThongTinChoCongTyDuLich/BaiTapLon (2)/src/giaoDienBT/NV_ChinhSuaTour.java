...
public class NV_ChinhSuaTour extends JFrame implements ActionListener, MouseListener{
	...
	public NV_ChinhSuaTour() {
		...
		pSouth.add(btnChinhSua = new JButton("Chỉnh Sửa Tour"));
	...
	public static void main(String[] args) {
		NV_ChinhSuaTour fm = new NV_ChinhSuaTour();
		fm.setVisible(true);
	}
