...
public class FormXoaDonThuoc extends JFrame {
	...
	public FormXoaDonThuoc() {
		...
		b1.add(lblMaDonThuoc = new JLabel("Chọn mã đơn hàng: "));
		b1.add(Box.createHorizontalStrut(20));
		String[] maKhachHang = {"Get value from function"};
		cbBoxModelMaDonThuoc = new DefaultComboBoxModel<String>(maKhachHang);
...
//		add(bWrap, BorderLayout.SOUTH);
	...
	public static void main(String[] args) {
		new FormXoaDonThuoc().setVisible(true);
	}
