...
public class GD_Phong extends JFrame implements ActionListener{
	 private JLabel lblsoP, lblLoai,lblGia,lblTT;
	 private JTextField txtsoP, txtLoai, txtGia, txtTT, txtMess;
	 ...
	 setTitle("Quản lý khách sạn");
		...
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		 ...
		 JPanel pNorth;
			...
			pNorth.add(lblGia = new JLabel("Giá phòng: "));
			
			pNorth.add(lblTT = new JLabel("Tình trạng: "));
			...
			lblGia.setBounds(20, 45, w1, h);
			txtGia.setBounds(120, 45, w2, h);
			lblTT.setBounds(20, 95, w1, h);
			txtTT.setBounds(120, 95, w2, h);
