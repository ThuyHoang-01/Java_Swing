...
public class JTableEditDemo extends JFrame 
		...
		if (o.equals(btnAdd))
		{
			if( txtHo.getText().equals("") || txtTen.getText().equals("")) 
				...
				{	
					...
					SinhVien sv = new SinhVien(txtMassv.getText(),
							txtHo.getText(), txtTen.getText());
					ds.themSinhVien(sv);
			...
			if (table.getSelectedRow() == -1)
				JOptionPane.showMessageDialog(this, "Phai chon dong can xoa.");	
					...
					int tl;
					tl = JOptionPane.showConfirmDialog(this,"Ban co muon xoa dong nay khong?", "Canh bao", JOptionPane.YES_NO_OPTION);
